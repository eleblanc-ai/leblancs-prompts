const tooltips = { 0: ["Coding:","Python, Svelte, Flask, Testing"],
                   ...
                   3: ["Software Documentation:","Code Explanation and Commenting, Technical tutorials"],
...
export const options = {
    ...
    labels: ['Coding', 'Math', 'Science', 'Software documentation', 'Research methodology', 'Data Visualization'],
    dataLabels: {
        enabled: false,
    ...
    series: [1,1,1,1,1,1],
    colors: ["#5ad45a", "#00b7c7", "#0d88e6","#1a53ff", "#4421af", "#b30000"],
    chart: {
        height: 270,
        width: '100%',
        type: 'donut',
