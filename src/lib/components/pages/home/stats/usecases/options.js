const tooltips = {0:["Open & Closed QA:","Providing answers to various question formats","#b30000"],
                  ...
                  6:["Classification:","Labeling text based on specified attributes","#5ad45a"]
                 }

export const options = {
  labels: ['Open & Closed QA', 'Summarization','Chain-of-thought','Multi-turn','Rewriting','Extraction','Classification'],
