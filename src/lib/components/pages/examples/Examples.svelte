    ...
    <p class="mt-4">
       ...
       <Accordion class="py-4">
        <AccordionItem>
          ...
          <p>
            Clicking the "Chat" button will display the dialogue between the user and the AI language model, presented in a messaging app-style format. This view allows you to follow the flow of the interaction and understand the context of the example.</p>
