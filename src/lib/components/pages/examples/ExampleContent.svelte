  ...
  {#if selectedView === 'conversation'}
    <div class="overflow-y-auto space-y-4">
      {#each conversation as message}
        <div 
          class="p-4 rounded-lg shadow-md w-11/12 transition-shadow duration-300 hover:shadow-lg border border-black"
        ...
        >
          <div class="flex justify-between items-center mb-2">
            <span class="font-semibold text-blue-800 text-lg" class:hidden={message.sender === 'user'}>
              Claude
            </span>
            <span class="font-semibold text-green-800 text-lg" class:hidden={message.sender === 'llm'}>
              User  
            </span>
          </div>
