<script>
   ...
   <div id="app" class="h-screen w-screen flex flex-col overflow-scroll" class:hide-scrollbar={hideScrollbar}>
    <Header bind:hide_stats bind:current_page/>
    <Body bind:hide_stats bind:current_page/>
    <Footer/>
   </div>